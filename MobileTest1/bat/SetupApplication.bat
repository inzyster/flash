...
:: Android packaging
set AND_CERT_NAME="MobileTest1"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\MobileTest1.p12
...
set IOS_PROVISION=cert\MobileTest1.mobileprovision
...
set APP_ID=air.MobileTest1

:: Output packages
set DIST_PATH=dist
set DIST_NAME=MobileTest1
